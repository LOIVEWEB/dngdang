(function () {
    ...
    function productImg(pid, size, img_num) {
        ...
        if (img_num > 1000) {
            ...
            return 'http://img3x' + pid % 10 + '.ddimg.cn/' + pid % 99 + '/' + pid % 37 + '/' + pid + '-' + img_num + '_' + size + '_' + img_version + '.jpg'
        } else {
            size = (typeof size == 'undefined' ? 'l' : size);
            return 'http://img3x' + pid % 10 + '.ddimg.cn/' + pid % 99 + '/' + pid % 37 + '/' + pid + '-' + img_num + '_' + size + '.jpg'
        }
    }
